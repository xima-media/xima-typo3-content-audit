...
class EmptyPages implements WidgetInterface
{
    ...
    {
        $template = GeneralUtility::getFileAbsFileName('EXT:xima_typo3_content_audit/Resources/Private/Templates/EmptyPages.html');
