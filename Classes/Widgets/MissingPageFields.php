...
class MissingPageFields implements WidgetInterface, RequestAwareWidgetInterface
{
    ...
    public function renderWidgetContent(): string
    {
        ...
        $missingField = $this->options['missingField'] ?? 'abstract';
        ...
        $view->assignMultiple([
            ...
            'missingFieldLabel' => $GLOBALS['LANG']->sL($GLOBALS['TCA']['pages']['columns'][$missingField]['label'] ?? $missingField),
            'version' => GeneralUtility::makeInstance(Typo3Version::class)->getMajorVersion(),
            'pageTreeFilterToken' => PageTreeFilterListener::TOKEN_MISSING_PAGE_FIELDS,
        ]);
        return $view->render('MissingPageFields');
    }
